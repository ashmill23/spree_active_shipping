...
# This file is a merged version of old active_shipping gem's ups.rb
# (https://github.com/Shopify/active_shipping/tree/v2.1.0) and
# spree_active_shipping gem's ups_override.rb (https://github.com/spree-contrib/spree_active_shipping)
module Spree
  module ActiveShipping
    class UPS < ::ActiveShipping::Carrier
      ...
      def parse_rate_response(origin, destination, packages, response, options={})
        ...
        if success
          rate_estimates = xml.root.css('> RatedShipment').map do |rated_shipment|
            ...
            ::ActiveShipping::RateEstimate.new(origin, destination, @@name,
      ...
      def parse_ship_accept(response)
        ...
        labels = packages.map do |package|
          ::ActiveShipping::Label.new(package["TrackingNumber"], Base64.decode64(package["LabelImage"]["GraphicImage"]))
        end

        ::ActiveShipping::LabelResponse.new(success, message, response_info, {labels: labels})
      end
